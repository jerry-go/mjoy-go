...
func (self *StateDB) Copy() *StateDB {
	...
	state := &StateDB{
		...
		stateObjects:      make(map[types.Address]*stateObject, len(self.stateObjectsDirty)),
		stateObjectsDirty: make(map[types.Address]struct{}, len(self.stateObjectsDirty)),
		refund:            self.refund,
...
func (s *StateDB) CommitTo(dbw trie.DatabaseWriter, deleteEmptyObjects bool) (root types.Hash, err error) {
