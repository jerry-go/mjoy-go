...
func (z *Receipt) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 6
	// write "PostState"
	err = en.Append(0x86, 0xa9, 0x50, 0x6f, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65)
	if err != nil {
		return
	}
...
func (z *Receipt) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 6
	// string "PostState"
	o = append(o, 0x86, 0xa9, 0x50, 0x6f, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65)
...
func (z *Receipt) Msgsize() (s int) {
	s = 1 + 10 + msgp.BytesPrefixSize + len(z.PostState) + 7 + msgp.UintSize + 6 + z.Bloom.Msgsize() + 5 + msgp.ArrayHeaderSize
	for za0001 := range z.Logs {
		if z.Logs[za0001] == nil {
			s += msgp.NilSize
		} else {
	...
	s += 7 + z.TxHash.Msgsize() + 16 + z.ContractAddress.Msgsize()
	return
}
...
// DecodeMsg implements msgp.Decodable
func (z *ReceiptMsgp) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
	...
	for zb0001 > 0 {
		...
		case "PostStateOrStatus":
			z.PostStateOrStatus, err = dc.ReadBytes(z.PostStateOrStatus)
			if err != nil {
				return
			}
		case "Bloom":
...
// EncodeMsg implements msgp.Encodable
func (z *ReceiptMsgp) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 3
	// write "PostStateOrStatus"
	err = en.Append(0x83, 0xb1, 0x50, 0x6f, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73)
	if err != nil {
		return
	}
	err = en.WriteBytes(z.PostStateOrStatus)
	if err != nil {
		return
	}
	// write "Bloom"
...
// MarshalMsg implements msgp.Marshaler
func (z *ReceiptMsgp) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 3
	// string "PostStateOrStatus"
	o = append(o, 0x83, 0xb1, 0x50, 0x6f, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73)
	o = msgp.AppendBytes(o, z.PostStateOrStatus)
	// string "Bloom"
	o = append(o, 0xa5, 0x42, 0x6c, 0x6f, 0x6f, 0x6d)
	o, err = z.Bloom.MarshalMsg(o)
	if err != nil {
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *ReceiptMsgp) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
	...
	for zb0001 > 0 {
		...
		switch msgp.UnsafeString(field) {
		case "PostStateOrStatus":
			z.PostStateOrStatus, bts, err = msgp.ReadBytesBytes(bts, z.PostStateOrStatus)
			if err != nil {
				return
			}
		case "Bloom":
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *ReceiptMsgp) Msgsize() (s int) {
	s = 1 + 18 + msgp.BytesPrefixSize + len(z.PostStateOrStatus) + 6 + z.Bloom.Msgsize() + 5 + msgp.ArrayHeaderSize
	for za0001 := range z.Logs {
		if z.Logs[za0001] == nil {
			s += msgp.NilSize
		} else {
	...
	for zb0001 > 0 {
		...
		case "Receipts_s":
			...
			if cap(z.Receipts_s) >= int(zb0002) {
				...
				z.Receipts_s = make([]Receipts, zb0002)
			}
			for za0001 := range z.Receipts_s {
				...
				if cap(z.Receipts_s[za0001]) >= int(zb0003) {
					...
					z.Receipts_s[za0001] = make(Receipts, zb0003)
				}
				for za0002 := range z.Receipts_s[za0001] {
					if dc.IsNil() {
						...
						if z.Receipts_s[za0001][za0002] == nil {
							z.Receipts_s[za0001][za0002] = new(Receipt)
						}
