...
func (z *Log) Msgsize() (s int) {
	...
	s += 5 + msgp.BytesPrefixSize + len(z.Data) + 12 + msgp.Uint64Size + 7 + z.TxHash.Msgsize() + 8 + msgp.UintSize + 10 + z.BlockHash.Msgsize() + 6 + msgp.UintSize + 8 + msgp.BoolSize
	return
}

// DecodeMsg implements msgp.Decodable
func (z *LogForStorage) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *LogForStorage) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 9
	// write "Address"
	err = en.Append(0x89, 0xa7, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73)
	if err != nil {
...
// MarshalMsg implements msgp.Marshaler
func (z *LogForStorage) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 9
	// string "Address"
	o = append(o, 0x89, 0xa7, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *LogForStorage) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *LogForStorage) Msgsize() (s int) {
	s = 1 + 8 + z.Address.Msgsize() + 7 + msgp.ArrayHeaderSize
	for za0001 := range z.Topics {
		s += z.Topics[za0001].Msgsize()
	}
