...
func makeStep5Obj(pApos *Apos , pCredential *CredentialSig , outMsgChan chan dataPack , step int)*step5CoinFixedTo0BBA{
...
func makeStep6Obj(pApos *Apos , pCredential *CredentialSig , outMsgChan chan dataPack , step int)*step6CoinFixedTo1BBA{
...
func makeStep7Obj(pApos *Apos , pCredential *CredentialSig , outMsgChan chan dataPack , step int)*step7CoinGenFlipBBA{
