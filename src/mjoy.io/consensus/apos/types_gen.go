...
// DecodeMsg implements msgp.Decodable
func (z *EmptyHash) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *EmptyHash) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 2
	// write "LastHash"
	err = en.Append(0x82, 0xa8, 0x4c, 0x61, 0x73, 0x74, 0x48, 0x61, 0x73, 0x68)
	if err != nil {
		return
	}
	err = z.LastHash.EncodeMsg(en)
	if err != nil {
		return
	}
	// write "Round"
...
// MarshalMsg implements msgp.Marshaler
func (z *EmptyHash) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 2
	// string "LastHash"
	o = append(o, 0x82, 0xa8, 0x4c, 0x61, 0x73, 0x74, 0x48, 0x61, 0x73, 0x68)
	o, err = z.LastHash.MarshalMsg(o)
	if err != nil {
		return
	}
	// string "Round"
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *EmptyHash) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
	...
	for zb0001 > 0 {
		...
		switch msgp.UnsafeString(field) {
		case "LastHash":
			bts, err = z.LastHash.UnmarshalMsg(bts)
			if err != nil {
				return
			}
		case "Round":
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *EmptyHash) Msgsize() (s int) {
	s = 1 + 9 + z.LastHash.Msgsize() + 6 + msgp.Uint64Size
	return
}
