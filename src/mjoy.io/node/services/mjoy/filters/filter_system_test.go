...
import (
	...
	"mjoy.io/core/blockchain/chainmaker"
...
func TestPendingTxFilter(t *testing.T) {
	...
	var (
		...
		transactions = []*transaction.Transaction{
			transaction.NewTransaction(0, types.HexToAddress("0xb794f5ea0ba39494ce83a213fffba74279579268"), new(big.Int), 0, new(big.Int), nil),
			transaction.NewTransaction(1, types.HexToAddress("0xb794f5ea0ba39494ce83a213fffba74279579268"), new(big.Int), 0, new(big.Int), nil),
			transaction.NewTransaction(2, types.HexToAddress("0xb794f5ea0ba39494ce83a213fffba74279579268"), new(big.Int), 0, new(big.Int), nil),
			transaction.NewTransaction(3, types.HexToAddress("0xb794f5ea0ba39494ce83a213fffba74279579268"), new(big.Int), 0, new(big.Int), nil),
			transaction.NewTransaction(4, types.HexToAddress("0xb794f5ea0ba39494ce83a213fffba74279579268"), new(big.Int), 0, new(big.Int), nil),
		}
