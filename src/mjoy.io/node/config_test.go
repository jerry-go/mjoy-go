...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "mjoyd.ipc", false, filepath.Join(os.TempDir(), "mjoyd.ipc")},
		{"data", "mjoyd.ipc", false, "data/mjoyd.ipc"},
		{"data", "./mjoyd.ipc", false, "./mjoyd.ipc"},
		{"data", "/mjoyd.ipc", false, "/mjoyd.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "mjoyd.ipc", true, `\\.\pipe\mjoyd.ipc`},
		{"data", "mjoyd.ipc", true, `\\.\pipe\mjoyd.ipc`},
		{"data", `\\.\pipe\mjoyd.ipc`, true, `\\.\pipe\mjoyd.ipc`},
	}
